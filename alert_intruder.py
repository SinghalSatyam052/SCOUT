...
def send_alert(sender_email, sender_password, recipient_email, video_path):
    ...
    try:
        ...
        body = (
            "Dear User,\n\n"
            "A unknown person was detected by our monitoring system. "
...
if __name__ == "__main__":
    ...
    recipient_email = "anujkiet123@gmail.com"
    video_path = "recording_20241130_131859.avi"  # Replace with your video file path
